...
from src.perception.objectDetection.objectDetector_thread  import ObjectDetector
...
if enableStream: # set up stream
    ...
    if enableCameraSpoof: # use spoof camera
        ...
        camProc = CameraProcess([],[camS1, camS2],[],[camQ])
    ...
    if enableVisualization:
        ...
        visProc = PerceptionVisualizer([camR1, laneR1, visOtherR], [visS],
...
if enableObjectDetection:
    ...
    objThread = ObjectDetector([camQ])
    print("created OD thread")
    objThread.start()
    print("started OD thread")
...
if enableRc: # use romote controller
    ...
    conProc = AutonomousController([laneR2],[nucS])
